...
desc %>% 
  ...
  rename(
    ...
    "minimum" = numeric.p0, 
    "lower quartile" = numeric.p25, 
    "median" = numeric.p50, 
    "upper quartile" = numeric.p75, 
...
the final bit of exploration will be to look for outliers in each column. We want to know if any columns are particularly affected and whether more cleaning is necessary. We will implement both z score tests and interquartile range tests and compare results.
