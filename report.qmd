...
desc_table <- desc %>% 
  kable(
    caption = "Feature Descriptions \\label{tab:feat-desc}", 
    digits = 3, 
    align = "c",
    booktabs = TRUE,
    na="-",
...
The results from logistic regression were promising given the simplicity of the model, with an accuracy of 85%. Weighting was not effective for improving the model, as expected given the balance of the class labels. Regularization and feature selection were also ineffective - somewhat suprising given the multicollinearilty seem in some columns. We saw that the model particularly underperformed at classifying class D correctly.
...
pruned_ward_dend <- set(pruned_ward_dend, "leaves_cex", 1.75) 
